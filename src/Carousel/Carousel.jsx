  ...
  return (
    <div>
      ...
      <div className="description">
        <h2 class="curved-underline">HelpOnYourWay - A handyman services listing application</h2><br />
        ...
        HandyMap not only streamlines the process of service discovery but also
        ensures data security and integrity through its implementation of Spring
        Security and MySQL database integration. Elevate your experience of
        finding and offering services with HelpOnYourWay – where technology meets
        convenience.
      </div>
    </div>
  );
